  ...
  ({ oddBgColor = 'odd:bg-app-greyish-blue', onClick, href, text }, ref) => {
    return (
      <a
        ...
        onClick={onClick}
        ref={ref}
        className={`card-hover-animation m-2 flex h-44 w-44 grow items-center justify-center rounded-lg p-8 text-center text-xl font-medium odd:bg-app-greyish-blue even:bg-app-semi-dark-blue ${oddBgColor}`}>
        {text}
      </a>
    )
  }
