...
export default function Navigation() {
  return (
    <nav className="bg-app-semi-dark-blue flex items-center justify-between p-5 sticky top-0 z-50 md:mx-6 md:mt-6 md:mb-[33px] md:rounded-[10px]">
      <Link href="/" passHref>
        <span>
          <AppLogo />
        </span>
      </Link>
      <ul className="flex items-center justify-between w-1/2 2xs:w-2/5">
        <NavigationIcon href="/">
          <IconNavHome />
        </NavigationIcon>
